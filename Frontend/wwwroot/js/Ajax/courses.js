...
function addCourse(data, cb) {
    $.ajax({
        type: 'POST', url: '/AttendanceManagement/Course', contentType: 'application/json', dataType: 'json', data: JSON.stringify(data),
        beforeSend: function () { $('#page-loader').fadeIn(150); },
...
function updateCourse(id, data, cb) {
    $.ajax({
        type: 'PUT', url: '/AttendanceManagement/Course/' + id, contentType: 'application/json', dataType: 'json', data: JSON.stringify(data),
        beforeSend: function () { $('#page-loader').fadeIn(150); },
...
function deleteCourse(id, cb) {
    $.ajax({
        type: 'DELETE', url: '/AttendanceManagement/Course/' + id, dataType: 'json',
        beforeSend: function () { $('#page-loader').fadeIn(150); },
...
function getDepartments(cb) {
    $.ajax({
        type: 'GET', url: '/AttendanceManagement/Department', dataType: 'json',
...
function getPrograms(cb) {
    $.ajax({
        type: 'GET', url: '/AttendanceManagement/Program', dataType: 'json',
        success: function (r) { if (typeof cb === 'function') cb(Array.isArray(r) ? r : []); },
        error: function () { if (typeof cb === 'function') cb([]); }
    });
}
...
function getSchedules(cb) {
    $.ajax({
        type: 'GET', url: '/AttendanceManagement/Schedule', dataType: 'json',
        success: function (r) { if (typeof cb === 'function') cb(Array.isArray(r) ? r : []); },
        error: function () { if (typeof cb === 'function') cb([]); }
    });
}
...
function getEnrollments(cb) {
    $.ajax({
        type: 'GET', url: '/AttendanceManagement/Enrollment', dataType: 'json',
        success: function (r) { if (typeof cb === 'function') cb(Array.isArray(r) ? r : []); },
        error: function () { if (typeof cb === 'function') cb([]); }
    });
}