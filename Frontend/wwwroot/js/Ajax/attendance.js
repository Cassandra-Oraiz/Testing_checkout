...
function markAttendance(data, cb) {
    $.ajax({
        type: 'POST', url: '/AttendanceManagement/Attendance', contentType: 'application/json', dataType: 'json', data: JSON.stringify(data),
        beforeSend: function () { $('#page-loader').fadeIn(150); },
...
function updateAttendance(id, data, cb) {
    $.ajax({
        type: 'PUT', url: '/AttendanceManagement/Attendance/' + id, contentType: 'application/json', dataType: 'json', data: JSON.stringify(data),
        beforeSend: function () { $('#page-loader').fadeIn(150); },
